...
import { Image as ImageIcon, PenTool, BarChart3, Link as LinkIcon } from 'lucide-react';

const items = [
  {
    title: 'Copy Generation',
    desc: 'Powered by Google Gemini 2.0 Flash for human-grade headlines, hooks, and CTAs.',
    icon: PenTool,
  },
  {
    title: 'Dual Image System',
    desc: 'Pollinations.AI + Stability.AI to craft on-brand, high-converting visuals.',
    icon: ImageIcon,
  },
  {
    title: 'Analytics & Insights',
    desc: 'Real-time performance and iteration loops built right into your workflow.',
    icon: BarChart3,
  },
  {
    title: 'Campaign Orchestrator',
    desc: 'Generate complete, platform-optimized campaigns in minutes, not hours.',
    icon: LinkIcon,
  },
];
  ...
  return (
    <section id="features" className="relative py-20 bg-black">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          Automate the ad pipeline — end to end
        </motion.h2>
